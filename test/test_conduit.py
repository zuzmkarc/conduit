...
class TestConduit(object):
    ...
    def click_logged_in_user_name(self):
        logged_in_user_name = self.browser.find_element_by_xpath('//a[@href="#/@csokinyuszi/" and @class="nav-link"]')
    ...
    def find_and_clear_element(self, element_xpath):
        web_element = self.browser.find_element_by_xpath(element_xpath)
        #web_element = WebDriverWait(self.browser, 2).until(EC.presence_of_element_located((By.XPATH, element_xpath)))
        web_element.clear()
        return web_element
