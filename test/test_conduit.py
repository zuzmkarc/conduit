...
class TestConduit(object):
    ...
    def test_login(self):
        registration(self.browser, (test_user["username_for_reg"]),(test_user["email_for_reg"]), (test_user["pwd_for_reg"]))
        login(self.browser, (test_user["email_for_reg"]), (test_user["pwd_for_reg"]))
        time.sleep(5)
        ...
        assert logged_in_user_name.text == test_user["username_for_reg"]
    ...
    def test_create_new_element(self):
        ...
        article_to_comment = WebDriverWait(self.browser, 6).until(
            EC.presence_of_element_located((By.XPATH, '//a[@href="#/articles/lorem-ipsum-dolor-sit-amet" and @class="preview-link"]')))
