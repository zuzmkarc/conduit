...
class TestConduit(object):
    ...
    def test_create_new_element(self):
        ...
        read_more_btn = self.browser.find_element_by_xpath('//a[@href="#/articles/szap"]/span')
        read_more_btn.click()
        time.sleep(3)
    ...
    def test_import_data_from_file(self):
        ...
        sign_in_btn.click()
        #time.sleep(3)
        #mail_field = self.browser.find_element_by_xpath('//input[@placeholder="Email"]')
        email_field = WebDriverWait(self.browser, 5).until(EC.presence_of_element_located((By.XPATH, '//input[@placeholder="Email"]')))
        email_field.clear()
        email_field.send_keys(test_user["email_valid"])
        #password_field = WebDriverWait(self.browser, 5).until(EC.presence_of_element_located((By.XPATH,'//input[@placeholder="Password"]')))
        ...
        #published_article = self.browser.find_element_by_xpath('//a[@href="#/articles/szap"]')
        published_article = WebDriverWait(self.browser, 5).until(EC.presence_of_element_located((By.XPATH, '//a[@href="#/articles/szap"]')))
        published_article.click()
        time.sleep(3)

        #comment_list_before = self.browser.find_elements_by_xpath('//p[@class="card-text"]')
        #comment_list_before = WebDriverWait(self.browser, 5).until(EC.presence_of_all_elements_located((By.XPATH, '//p[@class="card-text"]')))
        #print(len(comment_list_before))
        ...
        #comment_list_after= self.browser.find_elements_by_xpath('//p[@class="card-text"]')
        comment_list_after = WebDriverWait(self.browser, 5).until(EC.presence_of_all_elements_located((By.XPATH, '//p[@class="card-text"]')))
        time.sleep(3)
    ...
    #
       ...
       #assert len(comment_list_after) > len(comment_list_before)
